...
exports.default = (0, _react.createClass)({
    ...
    propTypes: {
        children: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.func, _react.PropTypes.element]),
    ...
    render: function render() {
        var _props2 = this.props,
            ...
            props = _objectWithoutProperties(_props2, ['children', 'text', 'style', 'min', 'max', 'mode', 'forceSingleModeWidth', 'perfectFit', 'throttle', 'autoResize', 'onReady']);
